...
function Icons() {
  return (
	...
	<a href="#">
		<i className="icons_head"><svg width="27" height="27" viewBox="0 0 32 32" fill="none"
	...
	<a href="">
		<input className='search' type="text" placeholder='Search' />
			<i className="icons_head-inp"><svg width="25" height="25" viewBox="0 0 32 32" fill="none"
							xmlns="http://www.w3.org/2000/svg">
